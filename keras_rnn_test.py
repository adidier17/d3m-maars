...
imageArray = np.load('mayone_orthoimage_timeseries_images.npy')
torque = np.load('mayone_orthoimage_timeseries_torque.npy')
roll = np.load('mayone_orthoimage_timeseries_roll.npy')
pitch = np.load('mayone_orthoimage_timeseries_pitch.npy')
...
path_best_model = '{}/07_27_2_keras_rnn_pose_best_model.keras'.format(pathy)
...
path_new_model = '{}/07_27_keras_rnn_pose_best_model.keras'.format(pathy)
